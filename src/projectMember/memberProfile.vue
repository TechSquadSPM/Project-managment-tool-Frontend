        ...
        <div id="main-content">
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="tab-content" id="option-tabContent" style="margin-left:15%;">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 center">
							<span class="profile-picture">
								<img class="editable img-responsive" style="height:150px;width:150px;" alt=" Avatar" id="avatar2" v-bind:src="'http://localhost:3000/images/Employees/' + profilearr[0].empProfile">
							</span>

							<div class="space space-4"></div>
                            <br><br>
							<router-link to="/memberEditProfile"><a href="#" class="btn btn-sm btn-block btn-success" style="background-color:lightgreen;">
								<i class="ace-icon fa fa-pencil bigger-120" style="color:black;"></i>
								<span style="color:black;">Edit Profile</span>
							</a></router-link>

							<a @click="oneditpassword" class="btn btn-sm btn-block btn-primary" style="background-color:lightblue;">
								<i class="ace-icon fa fa fa-pencil bigger-110" style="color:black;"></i>
								<span class="bigger-110" style="color:black;">Edit Password</span>
							</a>
						</div><!-- /.col -->
						<div class="col-xs-12 col-sm-12 center" style="font-size:20px;">
							<h4 class="blue">
                                <br><br>
								<span class="middle" style="font-size:40px;">{{profilearr[0].empFirstName}}&nbsp;{{profilearr[0].empLastName}}</span>
                                <br><hr>
							</h4>

							<div class="profile-user-info">
								<div class="profile-info-row">
									<div style="color:#667E99;"> Name </div>

									<div class="profile-info-value">
										<span>{{profilearr[0].empFirstName}} {{profilearr[0].empMiddleName}} {{profilearr[0].empLastName}}</span>
									</div>
								</div>
                                <div class="profile-info-row">
									<div style="color:#667E99;"> Email_Id </div>
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span>{{profilearr[0].empContactNo}}</span>
									</div>
								</div>
							</div>
